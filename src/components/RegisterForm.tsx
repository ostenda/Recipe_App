...
function RegisterForm() {
    ...
    return <>
        ...
        <div className="flex-column mx-auto justify-center items-center my-10">
            <h1 className="flex justify-center font-bold border-4
             border-yellow-900
             text-xl
             rounded-lg">Hi, you can find the register form below!</h1>
            <div className="container lm justify-center items-center my-20 border-8
